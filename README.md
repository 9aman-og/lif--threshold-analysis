...
## What It Does
I built a simple LIF neuron using snnTorch and fed it constant input current (0.2 amps) over 50 time steps. We then swept the firing threshold from 0.5 to 2.0 and measured how many spikes the neuron produced at each threshold value.
